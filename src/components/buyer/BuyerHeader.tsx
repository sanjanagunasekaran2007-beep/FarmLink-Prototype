      ...
      <header className="w-full bg-farm-navigation text-farm-navigation-text border-b border-farm-border px-4 sm:px-8 py-3.5 sticky top-0 z-30 select-none shadow-card transition-colors">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-farm-support flex items-center justify-center text-white shadow-subtle shrink-0 border border-farm-market/40">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <span className="hidden md:inline-flex items-center px-2 py-0.5 rounded-full bg-farm-navigation-text/10 text-farm-support text-[10px] font-bold uppercase border border-farm-support/40">
              ...
              <div className="flex items-center gap-1.5 text-xs text-farm-navigation-text/80 font-medium mt-0.5">
                <span className="font-bold text-farm-navigation-text truncate max-w-[140px] sm:max-w-none">
                  {businessName}
                </span>
                <span className="text-farm-navigation-text/40 hidden sm:inline">&bull;</span>
                <MapPin className="w-3.5 h-3.5 text-farm-market hidden sm:inline shrink-0" />
                <span className="truncate max-w-[160px] sm:max-w-none text-farm-navigation-text/80 hidden sm:inline">
                  {location}
                </span>
                <span className="text-farm-navigation-text/40 hidden sm:inline">&bull;</span>
                <span className="text-[10px] text-farm-market bg-farm-navigation-text/10 px-2 py-0.5 rounded-full hidden lg:inline border border-farm-border font-semibold">
